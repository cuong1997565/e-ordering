...
//    use DatabaseTransactions;
    ...
    {
        $this->store = new \App\Store\FactoryStore();

        parent::__construct($name, $data, $dataName);
    }


    public function testFactoryStoreSave()
    {
       $factory = factory(\App\Models\Factory::class)->make();

       $result = $this->store->save($factory);
       ...
       $result1 = $this->store->save($result);
        ...
        $this->assertTrue(is_object($result) && get_class($result) == \App\Models\Factory::class);

    }

    public function testFactoryStoreUpdate()
    {
        $factory = factory(\App\Models\Factory::class)->make();
        ...
        $this->assertTrue(is_object($result1) && get_class($result1) == \App\Models\Factory::class);
    }
}