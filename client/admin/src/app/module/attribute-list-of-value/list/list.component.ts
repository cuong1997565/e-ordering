...
export class ListComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (!this.app.curUser.role.permissions[this.app.constant.PERMISSION_LIST_ATTRIBUTE_LIST_OF_VALUES]) {
            this.router.navigate(['dashboard']);
        }
        this.ld = new ListData(this.app, this.route, 'attribute-lists-of-value');
    }
