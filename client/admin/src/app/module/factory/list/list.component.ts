...
export class ListComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      if (!this.app.curUser.role.permissions[this.app.constant.PERMISSION_LIST_FACTORIES]) {
          this.router.navigate(['dashboard']);
      }
     this.ld = new ListData(this.app, this.route, 'factories');
  }

    del(id, item) {
        this.url = 'factories/' + id + '/delete';
